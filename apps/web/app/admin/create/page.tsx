  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] px-4 py-8 sm:px-6 md:py-12 lg:px-10 bg-[var(--color-background)]">
      <section className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,0.9fr)]">
        <article
          className="rounded-3xl border border-[var(--color-border)]/50 bg-[#0D0F14]/50 p-8 sm:p-10 backdrop-blur-xl shadow-2xl"
        >
          <header className="space-y-4">
            <p className="text-sm font-bold uppercase tracking-widest text-[var(--color-primary)]">Founder Console</p>
            <h1 className="text-3xl font-bold text-white sm:text-4xl">Create a campaign</h1>
          ...
          <div className="space-y-2">
            <label htmlFor="description" className="text-sm font-bold text-white">
              Description
            </label>
            <textarea
              id="description"
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="space-y-2">
              <label htmlFor="productUrl" className="text-sm font-bold text-white">
                Product URL
              </label>
              <input
                id="productUrl"
            ...
            <div className="space-y-2">
              <label htmlFor="totalBudget" className="text-sm font-bold text-white">
                Total Budget (XLM)
              </label>
              <input
                id="totalBudget"
          ...
          <div className="space-y-2">
            <label htmlFor="founderSecret" className="text-sm font-bold text-white">
          ...
          {createdCampaign ? (
            <div className="mt-6 rounded-2xl border border-[var(--color-success)]/30 bg-[var(--color-success)]/10 p-5 backdrop-blur-sm">
              <p className="text-sm font-bold text-[var(--color-success)]">Campaign created: {createdCampaign.title}</p>
              <p className="mt-2 break-all text-xs font-mono text-[var(--color-muted)]">Wallet Address: {createdCampaign.walletAddress}</p>
              {createdCampaign.contractId ? (
                <p className="mt-1 break-all text-xs font-mono text-[var(--color-muted)]">Contract ID: {createdCampaign.contractId}</p>
              ) : null}
            </div>
          ) : null}
        </article>
        ...
        <aside className="rounded-3xl border border-[var(--color-border)]/50 bg-[#0D0F14]/30 p-8 backdrop-blur-md self-start">
          <h2 className="text-sm font-bold uppercase tracking-widest text-white">Launch Checklist</h2>
